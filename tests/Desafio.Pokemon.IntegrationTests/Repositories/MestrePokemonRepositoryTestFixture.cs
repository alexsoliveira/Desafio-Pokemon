...
{
    [CollectionDefinition(nameof(MestrePokemonRepositoryTestFixture))]
    public class CategoryRepositoryTestFixtureCollection
        : ICollectionFixture<MestrePokemonRepositoryTestFixture>
    { }

    public class MestrePokemonRepositoryTestFixture
        : BaseFixture
    {
